...
function validate() {
    ...
    if  (name1 == "") {  
        ...
        document.getElementById('signuppw').setCustomValidity('The password must be between (8 to 32) characters including Uppercase letter, Special character and Alphanumeric characters.');
        document.getElementById('signuppw').style.borderColor="red";
        return false;  
    }
    ...
    else if ((phone_match == null) || (phonenumber == "")) { 
